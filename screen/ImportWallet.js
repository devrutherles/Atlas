...
import { Animated, ScrollView, StyleSheet, Dimensions, ImageBackground , TextInput,Alert,KeyboardAvoidingView} from 'react-native';
    ...
    <View style={styles.container}>
      ...
      <View style={styles.circle} >
        <View flex-1>
          ...
          <View  marginT-375  style={{position:'absolute' ,alignSelf:'center',}}  width={'100%'}>
         
<View marginT-10 style={{position:'absolute', backgroundColor:'#1d1d1d' , width:'100%',height:400, alignSelf:'center'}}>

<Text style={{marginTop:40,marginBottom:20}} center={true} text105 marginB-5 marginT-3 color={'#fff'}>
CONNECTED WALLET ADDRESS
          ...
          <Button marginT-20 outline={true} outlineColor={'#32feff'}
            label={'CONNECTED'}
            style={{ marginBottom: ButtonSpace , borderRadius:4, alignSelf:'center'}}
